<?php
	...
	foreach($mallList as $list) :?>
		<?php $data = array_merge($data, DB::connection('sqlsrv')->select("SELECT MallKind, MallID, ProdInc, PnameP, Lprice, Sprice, Stock, PurlP, PimgP, Ccode1, Ccode2, Ccode3, Ccode4 FROM ".$list->TABLE_NAME));?>
		<table border=1>
