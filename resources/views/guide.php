	...
	<head>
		...
		<style>
			#guide_header_wrap {
				width: 100%;
				height: 200px;
				background-image: url('<?=$adr_img ?>guide_background.jpg');
	...
	<body>
		...
		<div id="guide_wrap">
			<div id="static_menu_wrap">
				<div class="gm_top" onclick='location.href="<?=$adr_ctr ?>Guide/index?no=1&det=1_1"'>
					직구 시작하기
				</div>
				<div class="gm_menu" onclick='location.href="<?=$adr_ctr ?>Guide/index?no=1&det=1_1"'>
					해외직구란?
				</div>
				<div class="gm_menu" onclick="move_scroll(900);">
					구매대행/배송대행/직배송
				</div>
				<div class="gm_menu" onclick='location.href="<?=$adr_ctr ?>Guide/index?no=1&det=1_2"'>
					간편 직구용어
				</div>
				<hr>
				<div class="gm_top" onclick='location.href="<?=$adr_ctr ?>Guide/index?no=2&det=2_1"'>
					쇼핑몰 둘러보기
				</div>
				<div class="gm_menu" onclick='location.href="<?=$adr_ctr ?>Guide/index?no=2&det=2_1"'>
					회원가입하기
				</div>
				<div class="gm_menu" onclick='location.href="<?=$adr_ctr ?>Guide/index?no=2&det=2_2"'>
					상품 주문하기
				</div>
				<div class="gm_menu" onclick='location.href="<?=$adr_ctr ?>Guide/index?no=2&det=2_3"'>
					주문서 작성하기
				</div>
				<hr>
				<div class="gm_top" onclick='location.href="<?=$adr_ctr ?>Guide/index?no=3&det=3_1"'>
					배송대행 이용하기
				</div>
				<div class="gm_menu" onclick='location.href="<?=$adr_ctr ?>Guide/index?no=3&det=3_1"'>
					배송대행 과정
				</div>
				<div class="gm_menu" onclick='location.href="<?=$adr_ctr ?>Guide/index?no=3&det=3_2"'>
					배대지 선택하기
				</div>
				<hr>
				<div class="gm_top" onclick='location.href="<?=$adr_ctr ?>Guide/index?no=4&det=4_1"'>
					직구 꿀팁
				</div>
			</div>
