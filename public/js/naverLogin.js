...
//        state_token = _getUrlParameter("state");
     ...
     * @private
     */
    _createAccessToken = function(code, callBack) {
    ...
    return {
        ...
        getAccessToken : function(code, callBack) {
            _createAccessToken(code, callBack);
        },
...
//            alert(URL.LOGIN)
        	window.open(URL.LOGIN + "?client_id=" + client_id + "&response_type=code&redirect_uri=" + encodeURIComponent(redirect_uri) + "&state=" + state_token, 'naverloginpop', 'titlebar=1, resizable=1, scrollbars=yes, width=600, height=550');
        }
    };
